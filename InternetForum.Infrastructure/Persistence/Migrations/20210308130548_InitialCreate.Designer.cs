...
namespace InternetForum.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20210308130548_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("InternetForum.Domain.Entities.Comment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("InternetForum.Domain.Entities.Comment", b =>
                {
                    b.HasOne("InternetForum.Domain.Entities.Post", "Post")
                        .WithMany("Comments")
            ...
            modelBuilder.Entity("InternetForum.Domain.Entities.ForumThreadUser", b =>
                {
                    b.HasOne("InternetForum.Domain.Entities.ForumThread", "ForumThread")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("InternetForum.Infrastructure.Identity.ApplicationUser", null)
                        .WithMany()
